...
export type LeadEventType =
  ...
  | "LEAD_ACTIVITY_UPDATED"
  | "LEAD_ACTIVITY_COMPLETED";
export type LeadActivityStatus =
  "PENDING" | "IN_PROGRESS" | "COMPLETED" | "CANCELED";
export type LeadActivityPriority = "LOW" | "MEDIUM" | "HIGH" | "URGENT";

export interface LeadExternalIdentity {
  id: string;
  provider: string;
  externalId: string;
...
export interface LeadActivity {
  ...
  responsibleUser?: Pick<User, "id" | "name" | "email">;
...
export interface Lead {
  ...
  assignedUser?: Pick<
    User,
    "id" | "name" | "email" | "phone" | "role" | "active" | "organizationId"
  > | null;
  managerUser?: Pick<
    User,
    "id" | "name" | "email" | "phone" | "role" | "active" | "organizationId"
...
export interface LeadExternalIdentityFormData {
  provider: string;
  externalId: string;
  externalAccountId?: string | null;
}
export interface LeadFormData {
  ...
  assignedUserId?: string | null;
  managerUserId?: string | null;
  externalIdentity?: LeadExternalIdentityFormData;
}
