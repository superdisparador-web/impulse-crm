...
export interface LeadFormData { name?: string | null; phone?: string | null; email?: string | null; document?: string | null; source?: LeadSource; status?: LeadStatus; temperature?: LeadTemperature; notes?: string | null; assignedUserId?: string | null; managerUserId?: string | null; externalIdentity?: LeadExternalIdentityFormData; }
...
export interface LeadListParams { page?: number; limit?: number; search?: string; status?: LeadStatus | ''; temperature?: LeadTemperature | ''; source?: LeadSource | ''; organizationId?: string; assignedUserId?: string; assigned?: boolean | ''; archived?: boolean | ''; createdFrom?: string; createdTo?: string; order?: 'asc' | 'desc'; }
export interface LeadListResponse { items: Lead[]; page: number; pageSize: number; total: number; totalPages: number; meta: { total: number; page: number; limit: number; totalPages: number }; }
