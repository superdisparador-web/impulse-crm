  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md rounded-xl border border-slate-800 bg-slate-950 p-6 shadow-2xl">
        <h2 id="archive-lead-title" className="text-xl font-bold">
          Arquivar lead?
        </h2>
        <p className="mt-2 text-slate-300">
          O lead {lead.name ? <strong>{lead.name}</strong> : "selecionado"} será
          removido da lista de ativos, sem exclusão definitiva.
        </p>
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            disabled={saving}
            onClick={onConfirm}
            className="rounded-lg bg-red-700 px-4 py-2 disabled:opacity-60"
          >
