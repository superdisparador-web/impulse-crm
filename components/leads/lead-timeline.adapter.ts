...
export function mapLeadTimeline({ lead, card, events, activities, notes }: { lead: Lead; card: PipelineCard; events: LeadEvent[]; activities: LeadActivity[]; notes: LeadNote[] }): Lead360TimelineItem[] {
