...
const embedded = readFileSync("backend/src/whatsapp/meta/meta-embedded-signup.service.ts", "utf8");
...
test("configuration and return origin are validated before creating a signed signup session", () => {
  ...
  for (const key of ["META_APP_ID", "META_APP_SECRET", "META_EMBEDDED_SIGNUP_CONFIG_ID", "META_GRAPH_API_VERSION", "FRONTEND_URL"])
